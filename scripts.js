...
let bgColor = '#ffffff';
container.computedStyleMap.backgroundColor = bgColor;

function createGrid() {

    let gridWidth = container.offsetWidthh / gridSize;
    ...
    const rightItems = document.quareSelectorAll(`.grid-item:nth-child(${gridSize}n)`);
    ...
    for (let i = 0; i < lastItems.length; i++) {
        ...
        lastItems[i].classList.toggle('border-right');
    }
}
